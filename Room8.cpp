...
Room8::Room8() {
	//printf("Constructing derived class Room8\n");
	set_name("Room8");
	set_room_id(1);
	set_exit("exit_2");
	Feature f1;
	Feature f2;
	f1.name = "Room8.feature_1";
	f1.description = "Room8.feature_1.description";
	set_feature_1(f1);
	f2.name = "Room8.feature_2";
	f2.description = "Room8.feature_2.description";
	set_feature_2(f2);
