...
Room8::Room8() {
	...
	set_exit_name("Door to \033[0;36mbathroom\033[0m", 0);
	set_exit_name("Door to hallway", 2);
	set_exit_name("Ladder to \033[0;36mattic\033[0m", 3);
	string exit_desc0 = "The doorway to the \033[0;36mbathroom\033[0m is to the \033[0;32mnorth\033[0m. ";
	string exit_desc2 = "The doorway back to the \033[0;36mhallway\033[0m is to the \033[0;32mwest\033[0m. ";
