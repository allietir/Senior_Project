...
Room4::Room4() {
	...
	set_extra_description("The room is uncomfortably warm and the smell of cooking flesh wafts in the air, the smell of fresh blood. ");
	set_room_id(3);
