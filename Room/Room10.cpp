...
int Room10::event_one(){
	printf("The porcelain \033[1;35mdoll\033[0m seems to whisper things but when you try to listen the whispers fade into nothing. ");
	set_event_triggered(0, 1);
	return 4;
}
int Room10::event_two(){
	printf("There is a porcelain \033[1;35mdoll\033[0m in the \033[1;31mchest\033[0m. ");
