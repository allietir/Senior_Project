...
Room14::Room14() {
	...
	set_extra_description("It feels like the weight of the house and its secrets are crushing your spirit and resolve. ");
	set_room_id(13);
...
int Room14::event_one(){
	...
	printf("You hear gears grinding as the \033[0;36mcrypt\033[0m door slowly slides open. ");
