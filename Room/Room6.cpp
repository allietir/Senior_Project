...
Room6::Room6() {
	...
	set_extra_description("The room is painted in colors that were once bright, but are now cracked and faded by time. ");
	set_room_id(5);

	set_feature_x(new Feature11, 0);//child
	set_feature_x(new Feature12, 1);//dollhouse
