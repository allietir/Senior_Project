...
int Feature3::use(int feat_obj_id){
	...
	if (feat_obj_id == 0){
		if(get_times_toggled(2)==0){
				string use_event = "You feel a chill and you see the \033[1;35mdoll\033[0m in the \033[1;31mgirl's\033[0m arms disapear. The \033[1;31mgirl's\033[1;31m face suddenly grows even sadder, and you see a single tear drop out of the \033[1;31mportrait\033[0m and onto your feet. ";
					func_togg_count_x(2);
					printf("%s\n", use_event.c_str());
			}
