...
Feature10::Feature10() {
	...
	set_desc("There is a \033[1;31mpainting\033[0m of a beautiful woman sleeping with her eyes closed. ");
	set_index_id(9);
}
int Feature10::speak(){
	
	if (get_times_toggled(SPEAK)==0){
		if (get_desc().compare("There is a \033[1;31mpainting\033[0m of a beautiful woman sleeping with her eyes closed. ")!=0){
