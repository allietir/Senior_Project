...
int main(int argc, char *argv[]) {
		...
		string name_input;
		string intro_one = "You and your best friend Alex\nwere hanging out like you always do.\nYou've been through the best of times\nand the worst of times together. Today, you were exploring and happened upon an old, abandoned house. Let's go check it out, Alex says eagerly as they wiggle through the broken gate. You get that feeling that this is a terrible idea but decide to shrug it off and follow Alex through the gate... ";
